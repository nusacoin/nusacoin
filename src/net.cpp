...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Nusacoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"nusaco.in", "dnsseed.nusaco.in"},
    {"", "50.16.206.102"}, //InternetApe's seed node
	{NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"nusaco.in", "testnet-seed.nusaco.in"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Nusacoin is probably already running."), addrBind.ToString().c_str());
        else
